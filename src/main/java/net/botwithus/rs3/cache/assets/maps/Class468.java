package net.botwithus.rs3.cache.assets.maps;/* Class468 - Decompiled by JODE
...
public class Class468 {
    ...
    void method5533(ByteBuffer buffer, boolean bool) {
        if (bool)
            method5528(buffer);
        else {
            aClass471_5175 = new Class471(buffer);
            aClass459_5173 = new Class459(buffer);
            this.aClass459_5176 = new Class459(buffer);
        }
    }
